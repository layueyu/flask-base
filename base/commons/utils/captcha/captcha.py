...
class Captcha(object):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        if not hasattr(cls, '__instance'):
            cls.__instance = super(Captcha, cls).__new__(cls)
    ...
    def __noise(self, image, number=50, level=2, color=None):
    ...
    def __text(self, image, fonts, font_sizes=None, drawings=None, squeeze_factor=0.75, color=None):
    ...
    def __captcha(self, path=None, fmt='JPEG'):
        """Create a captcha.
